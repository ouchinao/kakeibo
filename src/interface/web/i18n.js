...
export const translations = {
  en: {
    ...
    "label.inputCurrency": "Entry currency",
    "label.displayCurrency": "Display currency",
    "label.trendRange": "Trend range",
    "label.rate": "Rate to base currency",
    "hint.displayConverted": "Totals converted to {currency} at {rate}",
    "hint.displayUnavailable": "No rate available — totals shown in {currency}",
  ...
  ja: {
    ...
    "label.language": "言語",
    "label.currency": "通貨",
    "label.inputCurrency": "入力通貨",
    "label.displayCurrency": "表示通貨",
    "label.trendRange": "推移の期間",
    "label.rate": "基軸通貨へのレート",
    "hint.displayConverted": "合計を {currency} に換算表示（レート {rate}）",
    "hint.displayUnavailable": "レートを取得できないため {currency} で表示します",
